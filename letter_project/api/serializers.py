...
class LetterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # This correctly tells the serializer that while 'registered_by_username'
        # is a model field, it is not required in the client's POST request because
        # the server will provide it. This resolves the 500 error.
        extra_kwargs = {
            'registered_by_username': {'required': False, 'read_only': True}
        }
